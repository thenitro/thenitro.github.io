function responsiveMobileMenu() {
	$('.nav').each(function() {
		...
		let $style = $(this).attr('nav-menu-style'); // get menu style
...
function getMobileMenu() {
	...
	$('.nav').each(function() {
		let menutitle = $(this).attr("nav-menu-title");
		if (menutitle == "") {
			menutitle = "";
		} else if (menutitle == undefined) {
			menutitle = "";
		}
		let $menulist = $(this).children('.nav-menu').html();
		let $menucontrols = "<div class='nav-toggled-controls'><div class='nav-toggled-title'>" + menutitle + "</div><div class='nav-button'><span>&nbsp;</span><span>&nbsp;</span><span>&nbsp;</span></div></div>";
...
$(document).ready(function() {
	...
	let $submenus = $('.nav.yoga .nav-menu li > ul');
	$submenus.hide();
	...
	let $submenusSm = $('.nav.yoga .nav-toggled li > ul');s
	$submenusSm.hide();
